...
(function() {
    ...
    function groupByYear(publications) {
        ...
        // Get years and sort numerically in descending order (2025, 2024, 2023...)
        const years = Object.keys(grouped).map(y => parseInt(y));
        years.sort((a, b) => b - a); // Descending: newest first
    ...
    function renderPublications(groupedPubs) {
        ...
        Object.keys(groupedPubs).forEach((year) => {
            const pubs = groupedPubs[year];
